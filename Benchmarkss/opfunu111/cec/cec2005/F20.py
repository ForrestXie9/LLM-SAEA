#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 19:31, 20/04/2020                                                        %
#                                                                                                       %
...
class Model(Root):
    def __init__(self, f_name="Rotated Hybrid Composition Function 2 with Global Optimimum on the Bounds",
    ...
    def _main__(self, solution=None):
        ...
        if problem_size == 10 or problem_size == 30 or problem_size == 50:
            ...
            print("CEC 2005 F20 function only support problem size 10, 30, 50")
            return 1
        num_funcs = 10
        C = 2000
