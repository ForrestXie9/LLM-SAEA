...
class Root:
    def __init__(self, f_name=None, f_shift_data_file=None, f_ext='.txt', f_bias=None):
        ...
        self.f_ext = f_ext
        self.f_bias = f_bias
        self.current_path = pkg_resources.resource_filename("opfunu111", "cec/cec2005/")
        self.support_path_data = pkg_resources.resource_filename("opfunu111", "cec/cec2005/support_data/")
