#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 19:11, 20/04/2020                                                        %
#                                                                                                       %
...
class Model(Root):
    def __init__(self, f_name="Rotated Hybrid Composition Function 2", f_shift_data_file="data_hybrid_func2",
    ...
    def _main__(self, solution=None):
        ...
        if problem_size == 10 or problem_size == 30 or problem_size == 50:
            ...
            print("CEC 2005 F18 function only support problem size 10, 30, 50")
            return 1
        num_funcs = 10
        C = 2000
        xichma = array([1, 2, 1.5, 1.5, 1, 1, 1.5, 1.5, 2, 2])
        lamda = array([2*5.0/32, 5.0/32, 2*1, 1, 2*5.0/100, 5.0/100, 2*10, 10, 2*5.0/60, 5.0/60])
